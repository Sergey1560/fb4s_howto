...
| CLK   | PH4 CLK        | линия тактирования CLOCK |
...
Для подключения к линиям хоста нужно добавить mcu в виде процесса в линукс:
...
Нужно добавить mcu в виде процесса в линуксе (точно так же, как в случае аппаратного SPI).
